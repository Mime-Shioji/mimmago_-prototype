...
import characterImage from "figma:asset/08f84dae68e841865cfa397d0b1ad8fd7eb3e958.png";
...
export function WelcomeScreen() {
  ...
  return (
    <div className="flex flex-col items-center justify-start gap-6 py-8 px-4">
      <div className="flex items-center justify-center size-32 rounded-full overflow-hidden shadow-lg">
        <img src={characterImage} alt="みんまご" className="w-full h-full object-cover" />
      </div>
